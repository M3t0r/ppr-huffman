 ...
 * @param p_heap Der Heap.
 * @return NULL wenn kein Element mehr vorhanden, ansonsten das minimale Element.
 */
 ...
 * @param p_heap Der Heap.
 * @return Die Anzahl der Elemente im Heap.
 */
 ...
 * @param p_heap Der Heap.
 * @param index Der gewünschte Index (0-basiert).
 * @return void* falls der Index invalide war, das gewünschte Element sonst.
 */
